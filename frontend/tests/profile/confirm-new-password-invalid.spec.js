...
test('Profile - change name', async ({ page }) => {
    ...
    await inputNewPassword.fill('12345');
    const inputPassword = page.locator('input[name="confirmPassword"]');
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'tests/profile/screenshots/confirm-new-password-invalid.png' });
});