...
test('checkout - province blank', async ({ page }) => {
  ...
  await page.locator('select[name="province"]').selectOption('');
  ...
  await page.screenshot({ path: 'tests/checkout/screenshots/province-blank.png' });
});