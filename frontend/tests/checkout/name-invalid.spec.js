...
test('checkout - name invalid', async ({ page }) => {
  ...
  await page.locator('input[name="fullName"]').fill('12');
  ...
  await page.screenshot({ path: 'tests/checkout/screenshots/name-invalid.png' });
});