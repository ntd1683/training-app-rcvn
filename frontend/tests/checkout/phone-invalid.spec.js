...
test('checkout - phone invalid', async ({ page }) => {
  ...
  await page.locator('input[name="phone"]').fill('023412aavs');
  ...
  await page.screenshot({ path: 'tests/checkout/screenshots/phone-invalid.png' });
});